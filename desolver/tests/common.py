...
# if D.backend() == 'torch':
#     device_var_set = [pytest.param('cpu', marks=pytest.mark.cpu)]
#     import torch
#     if torch.cuda.is_available():
#         device_var_set.insert(0, pytest.param('cuda', marks=pytest.mark.gpu))
# else:
#     device_var_set = [None]
...
# device_param       = pytest.mark.parametrize('device', device_var_set)
