...
# In Beta Development
**3.0.0b8** - PyAudi support has been added to the module. It is now possible to do numerical integrations using `gdual` variables such as `gdual_double`, `gdual_vdouble` and `gdual_real128`.
 
This version can be installed with `pip install desolver[pyaudi]==3.0.0b8`
